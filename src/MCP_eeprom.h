...
class MCP_eeprom {
    public:
        ...
        // bit 1 << 4 - input 1 - PIR Sensor
        // bit 1 << 5 - input 1 - ON by twilight sensor | 0 None
        // bit 1 << 6 - input 1 - 
        // bit 1 << 7 - input 1 - 

        uint8_t OutputConf[64];
        // bit 1 << 0 - output 1 - Enable | Disable output 
        // bit 1 << 1 - output 1 - Bistable | 0 - Monostable
        // bit 1 << 2 - output 1 - OFF by Armed Alarm |  0 none
        // bit 1 << 3 - output 1 - 
        // bit 1 << 4 - output 1 - ? ON by Activated Alarm | 0 None
        // bit 1 << 5 - output 1 - ? ON by Activated PIR Sensor
        // bit 1 << 6 - output 1 - 
        // bit 1 << 7 - output 1 - 
